...
public class ProjectPermission {
    ...
    private Short exportPermission = 0;

    private Short collectsPermission = 0;
     ...
     * 是否有发布权限
     */
    private Boolean deployPermission = false;
    ...
    public ProjectPermission(Short permission) {
        ...
        this.collectsPermission = permission;
    }
    ...
    public static ProjectPermission adminPermission() {
        ...
        permission.setDeployPermission(true);
