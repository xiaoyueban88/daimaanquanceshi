...
public interface MemDashboardWidgetMapper {
    ...
    List<MemDashboardWidget> getSimpleInfoByDashboardIds(@Param("list") List<Long> dashboardIds);
    ...
    @Delete("delete from mem_dashboard_widget where widget_Id = #{widgetId} and widget_type = #{widgetType}")
