...
public class DisplayServiceImpl extends VizCommonService implements DisplayService {
     ...
     */
    @Override
    public List<Display> getDisplayListByProject(Long projectId, User user) throws NotFoundException, UnAuthorizedException, ServerException {
    ...
    @Override
    public String shareDisplay(Long id, User user, String username) throws NotFoundException, UnAuthorizedException, ServerException {
        DisplayWithProject displayWithProject = displayMapper.getDisplayWithProjectById(id);
    ...
    @Override
    @Transactional
    public Display copyDisplay(Long id, User user) throws NotFoundException, UnAuthorizedException, ServerException {
