...
public class SourceServiceImpl implements SourceService {
     ...
     */
    @Override
    public List<Source> getSources(Long projectId, User user) throws NotFoundException, UnAuthorizedException, ServerException {
    ...
    @Override
    public SourceDetail getSourceDetail(Long id, User user) throws NotFoundException, UnAuthorizedException, ServerException {
    ...
    public Source createSource(SourceCreate sourceCreate, User user) throws NotFoundException, UnAuthorizedException, ServerException {
        ...
        if (projectPermission.getSourcePermission() < UserPermissionEnum.WRITE.getPermission()) {
            throw new UnAuthorizedException("you have not permission to create source");
        }
    ...
    public Source updateSource(SourceInfo sourceInfo, User user) throws NotFoundException, UnAuthorizedException, ServerException {
        ...
        if (projectPermission.getSourcePermission() < UserPermissionEnum.WRITE.getPermission()) {
            throw new UnAuthorizedException("you have not permission to update this source");
        }
    ...
    public boolean deleteSrouce(Long id, User user) throws NotFoundException, UnAuthorizedException, ServerException {
        ...
        if (projectPermission.getSourcePermission() < UserPermissionEnum.DELETE.getPermission()) {
            throw new UnAuthorizedException("you have not permission to delete this source");
        }
     ...
     */
    @Override
    public void validCsvmeta(Long sourceId, UploadMeta uploadMeta, User user) throws NotFoundException, UnAuthorizedException, ServerException {
        ...
        if (projectPermission.getSourcePermission() < UserPermissionEnum.WRITE.getPermission()) {
            throw new UnAuthorizedException("you have not permisson to upload csv file in this source");
        }
    ...
    public Boolean dataUpload(Long sourceId, SourceDataUpload sourceDataUpload, MultipartFile file, User user, String type)
        ...
        if (projectPermission.getSourcePermission() < UserPermissionEnum.WRITE.getPermission()) {
            throw new UnAuthorizedException("you have not permission to upload data in this source");
        }
    ...
    @Override
    public boolean reconnect(Long id, DbBaseInfo dbBaseInfo, User user) throws NotFoundException, UnAuthorizedException, ServerException {
        Source source = sourceMapper.getById(id);
        if (null == source) {
            log.info("source (:{}) is not found", id);
            throw new NotFoundException("source is not found");
        ...
        if (projectPermission.getSourcePermission() < UserPermissionEnum.WRITE.getPermission()) {
            ...
            throw new UnAuthorizedException("You have not permission to reconnect this source");
        }
