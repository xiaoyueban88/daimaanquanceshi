...
public class SheetContext implements Serializable {
    ...
    public static final class SheetContextBuilder {
        ...
        public SheetContextBuilder withColSql(String colSql) {
            this.colSql = colSql;
            return this;
        }

        public SheetContextBuilder withRowSql(String rowSql) {
            this.rowSql = rowSql;
            return this;
        }
        public SheetContextBuilder withMetricKey(String metricKey) {
            this.metricKey = metricKey;
            return this;
        }
        public SheetContextBuilder withExecuteParam(ViewExecuteParam executeParam) {
        ...
        public SheetContextBuilder withHasTemplate(Boolean hasTemplate) {
        ...
        public SheetContext build() {
            ...
            sheetContext.setColSql(colSql);
            sheetContext.setRowSql(rowSql);
            sheetContext.setMetricKey(metricKey);
            ...
            sheetContext.setExecuteParam(executeParam);
            sheetContext.setHasTemplate(hasTemplate);
            return sheetContext;
        }
    }
