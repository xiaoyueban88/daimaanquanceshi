...
public class WorkBookContext implements Serializable {
    ...
    private String waterMarkContext;
    ...
    public static final class WorkBookContextBuilder {
        ...
        public WorkBookContextBuilder withWaterMarkText(String waterMarkContext) {
            if (!"undefined".equals(waterMarkContext)) {
                this.waterMarkContext = waterMarkContext;
            }
            return this;
        }

        public WorkBookContextBuilder withTemplate(InputStream template) {
            this.template = template;
            return this;
        }

        public WorkBookContextBuilder withLocalPath(boolean localPath) {
        ...
        public WorkBookContext build() {
            ...
            workBookContext.setWaterMarkContext(waterMarkContext);
            workBookContext.setTemplate(template);
            workBookContext.setLocalPath(localPath);
