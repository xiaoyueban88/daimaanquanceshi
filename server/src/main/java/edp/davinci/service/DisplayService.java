...
public interface DisplayService extends CheckEntityService {
    ...
    String shareDisplay(Long id, User user, String username) throws NotFoundException, UnAuthorizedException, ServerException;
    ...
    Display copyDisplay(Long id, User user) throws NotFoundException, UnAuthorizedException, ServerException;
}
