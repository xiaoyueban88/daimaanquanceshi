...
import edp.davinci.core.inteceptor.CorsFilter;
...
import edp.davinci.core.inteceptor.PlatformShareAuthInterceptor;
import edp.davinci.extention.DatartDateCodec;
...
public class WebMvcConfig extends WebMvcConfigurationSupport {
    ...
    @Bean
    public PlatformShareAuthInterceptor platformShareAuthInterceptor() {
        return new PlatformShareAuthInterceptor();
    }
    ...
    protected void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(loginRequiredInterceptor())
                ...
                .excludePathPatterns(Constants.BASE_API_PATH + "/openapi/**");

        registry.addInterceptor(platformAuthInterceptor())
                .addPathPatterns(Constants.AUTH_API_PATH + "/**");

        registry.addInterceptor(platformShareAuthInterceptor())
                .excludePathPatterns(Constants.PLATFORM_API_PATH + "/download/share/record/**")
                .addPathPatterns(Constants.PLATFORM_API_PATH + "/**");
    ...
    protected void configureMessageConverters(List<HttpMessageConverter<?>> converters) {
        ...
        //解决fastjson在1.2.83版本后java.sql.Date格式化后带时分秒的问题
        fastJsonConfig.getSerializeConfig().put(java.sql.Date.class, DatartDateCodec.instance);
