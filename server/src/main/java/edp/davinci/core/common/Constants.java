...
public class Constants extends Consts {
     ...
     * platform基本路径
     */
    public static final String PLATFORM_API_PATH = "/platform/v3";
    /**
     * 用户激活 / 重发激活邮件模板
     */
     ...
     * 是否有dashboard下载权限
     */
    public static final String HAS_DOWNLOAD_PERMISSION = "hasDownloadPermission";
     ...
     * 获取union distinct
     */
    public static final String SQL_TEMPLATE_FUNCTION_UNIONDISTINCT = "queryUnionDistinctSql";
