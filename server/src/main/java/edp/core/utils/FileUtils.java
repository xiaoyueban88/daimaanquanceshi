...
public class FileUtils {
    ...
    public String getFilePath(FileTypeEnum type, String folderPath, MsgWrapper msgWrapper) {
    ...
    public String getDirPath(FileTypeEnum type, MsgWrapper msgWrapper) {
        StringBuilder sb = new StringBuilder(this.fileBasePath);
        if (!sb.toString().endsWith(File.separator)) {
            sb.append(File.separator);
        }
        ...
        sb.append(UNDERLINE).append(System.currentTimeMillis());
        File dir = new File(sb.toString());
        if (!dir.exists()) {
            dir.mkdirs();
        }
