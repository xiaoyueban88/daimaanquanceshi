...
public class RSAEncrypt {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String clientSecret = privateEncrypt("xkzy-zysjhyy", privateKey);
        System.out.println("第三方平台clientSecret：" + clientSecret);
        String s1 = publicDecrypt(clientSecret, publicKey);
        System.out.println("白泽数据库clientSecret: " + BCrypt.hashpw(s1, BCrypt.gensalt()));
    }
