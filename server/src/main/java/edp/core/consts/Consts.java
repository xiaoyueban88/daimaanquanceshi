...
public class Consts {
    ...
    public static final String TOKEN_HEADER_SHARE_STRING = "ShareAuthorization";
    ...
    public static final String ACESS_KEY = "acess";
     ...
     * widget type
     */
    public static final Integer NORMAL_WIDGET_TYPE = 0;
    public static final Integer CONTAINER_WIDGET_TYPE = 1;

    public static final String STRING_VIEWEXECUTEPARAM = "viewExecuteParam";

    public static final String STRING_SQL = "sql";

    public static final String STRING_EXCLUDECOLUMNS = "excludeColumns";

    public static final String STRING_DATA = "data";

    public static final String STRING_DISTINCT = "distinct";

    // 24 小时
    public static final int DAY_SECOND_TIME = 24 * 60 * 60;

    public static final List<String> UDF_FUNCTION_NAMES = Lists.newArrayList("cumSum", "cumCount", "groupSum", "groupCount");

    // sql聚合函数
    public static final List<String> AGG_FUN_NAMES = Lists.newArrayList("count", "sum", "avg", "min", "max");

    public static final List<String> LETTER_LIST = Lists.newArrayList("a", "b", "c", "d", "e", "f", "g", "h",
            "i", "j", "k", "l", "m", "n", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w",
            "x", "y", "z");

    public static final Map<String, String> CLICKHOUSE_ARRAY_FUNCTION = Maps.newHashMap();

    static {
        CLICKHOUSE_ARRAY_FUNCTION.put("indexUniq", "arrayEnumerateUniq");
        CLICKHOUSE_ARRAY_FUNCTION.put("arrayEnumerateUniq", "arrayEnumerateUniq");
    }

    public static final String LOG_SDK_OPCODE = "baize_view";

    public static final List<String> CLICKHOUSE_HIGHER_ORDER_FUNCTIONS = Lists.newArrayList(
            "ARRAYMAP", "ARRAYFILTER", "ARRAYCOUNT", "ARRAYEXISTS", "ARRAYALL", "ARRAYSUM",
            "ARRAYFIRST", "ARRAYFIRST", "ARRAYFIRSTINDEX", "ARRAYCUMSUM", "ARRAYCUMSUMNONNEGATIVE", "ARRAYSORT",
            "ARRAYREVERSESORT"
    );

    // 基本数据类型
    public static final List<String> BASE_DATA_TYPE_LIST = Lists.newArrayList("byte", "short", "int", "long",
            "float", "double", "boolean", "char");


    public static final String EXCEL_DOWNLOAD_RECORD_LIMIT_MSG = "下载excel的请求频繁，请稍后再试";
}
